...
const kEventState = Symbol('EventState');
...
class Event {
     ...
     */
    get currentTarget() {
        return this._state.currentTarget;
    }

    get _state() {
        return this[kEventState];
    }
     ...
     */
    composedPath() {
        const currentTarget = this._state.currentTarget;
     ...
     */
    get eventPhase() {
        return this._state.eventPhase ?? false;
    }
     ...
     */
    get bubbles() {
        return Boolean(this._state.eventInit.bubbles);
    }
     ...
     */
    get cancelable() {
        return Boolean(this._state.eventInit.cancelable);
    }
     ...
     */
    get composed() {
        return Boolean(this._state.eventInit.composed);
    }
...
class CustomEvent extends Event {
     ...
     */
    get detail() {
        return Boolean(this._state.eventInit.detail);
    }
}
...
function isStopped(event) {
    return event._state.immediateStopped;
}
...
function setEventPhase(event, eventPhase) {
    event._state.eventPhase = eventPhase;
}
...
function setCurrentTarget(event, currentTarget) {
    event._state.currentTarget = currentTarget;
}
...
function setPassiveListener(event, passiveListener) {
    event._state.passiveListener = passiveListener;
}
...
class EventTarget {
    ...
    getEventListeners(eventName) {
        const listeners = getListeners(this);
        if (eventName) {
            return { eventName: listeners[eventName] };
        }
